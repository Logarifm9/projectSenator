...
export const aboutData = [
  ...
  },
  {
    ...
    info: [
      {
        title: 'Kancelaria Ochrony Prawnej w Sieci to zespół specjalistów z wieloletnim doświadczeniem w obszarze prawa, który skoncentrowany jest na zagadnieniach związanych z cyberprzestępczością oraz ochroną danych osobowych. Od momentu założenia kancelarii, skutecznie pomagamy naszym klientom w walce z zagrożeniami w sieci, oferując profesjonalne doradztwo oraz reprezentację prawną w sprawach dotyczących oszustw internetowych, kradzieży tożsamości, cyberataków oraz naruszenia prywatności.Wieloletnia praktyka w zwalczaniu cyberprzestępczości Dzięki wieloletniemu doświadczeniu w obszarze prawa internetowego oraz ścisłej współpracy z ekspertami IT, udało nam się skutecznie rozwiązać setki spraw związanych z cyberprzestępczością. Zajmujemy się zarówno indywidualnymi przypadkami, jak i комплексową obsługą prawną firm, które padły ofiarą oszustw internetowych, ataków hakerskich, a także naruszeń bezpieczeństwa danych.Zaufanie, które budujemy każdego dnia',
      },
    ],
  },
];
